...
export default function Section8r() {
  ...
  return (
    <section className="w-full xl:hidden py-4 mb-[1rem] px-[1rem] md:px-[8rem] mt-[100px] max-w-screen-2xl mx-auto select-none">
            ...
            <div key={item.id} className="flex justify-center p-1 md:p-2">
              <div className="flex items-center justify-center">
                ...
                >
                    ...
                    <div className="flex gap-2 mr-[110px] mt-[30px] mb-[-50px] ">
                     <div className="w-[90px] h-[90px] p-5 -full  flex-row mb-[10px]">
                    <Image
                      width={200}
                      height={200}
                      alt="service"
                    ...
                    /></div>
                  <h3 className={`text-center min-h-[80px] py-3  text-[16px] text-[#000000] md:font-medium `}>
                    {item.title}
                  </h3>
                  </div>
                                      <div className="flex gap-2 ml-[-10px] mt-[-10px]">
                                      <FaStar className="text-[#FFA41B] w-[20px]" />
                                      <FaStar className="text-[#FFA41B] w-[20px]"/>
                                      <FaStar className="text-[#FFA41B] w-[20px]"/>
                                      <FaStar className="text-[#FFA41B] w-[20px]"/>
                                      <FaStar className="text-[#FFA41B] w-[20px]"/>
