        ...
        <div className="px-[80px] max-w-screen-2xl mx-auto py-[100px] mt-[100px]">
            ...
            <div className="flex absolute top-[60px]  px-[60px] gap-20">
                <div className="">
                    ...
                    <p className="2xl:text-[16px] xl:text-[14px] font-medium text-[#F8E9FECC]/80 pt-[10px] 2xl:w-[600px] xl:w-[500px] pb-[50px] ">Manage your money smarter — send, receive, and pay instantly with complete security and convenience.  Enjoy cashback rewards, quick transfers, and exclusive merchant discounts — all in one app.</p>
