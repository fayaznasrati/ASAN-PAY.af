...
<Link href="/Aboutus"> <button className=" mx-auto w-full xl:w-30 2xl:w-40 xl:mx-0  xl:px-3 p-3 rounded-full bg-gradient-to-r from-[#2E8C7A] to-[#0C2621] text-[#FFFFFF] 2xl:text-[18px] xl:text-[16px]  font-bold cursor-pointer">Learn More</button> </Link> 
            </div>
