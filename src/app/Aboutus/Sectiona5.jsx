...
<Image
                                                              ...
                                                              width={2200}
                                                              height={400}
                                                              className=" 2xl:w-[650px] xl:w-[550px] 2xl:h-[650px] xl:h-[550px] mb-[80px] "
                                                              alt="homeImage"
                                                              />
<p className="text-[#5B5B5B] 2xl:text-[18px] xl:text-[16px] font-normal 2xl:w-[550px] xl:w-[450px] text-center ml-[80px]">Seamlessly manage your money, make secure transactions, 
