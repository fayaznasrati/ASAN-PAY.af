...
const Sectionc4 = () => {
  return (
    <div className="  relative z-[99999] top-[120px] w-full mx-auto items-center content-center text-center pb-[100px] max-w-screen-2xl hidden xl:block">
      <div className="grid grid-cols-3  px-[80px]">
        {featurescard.map((feat) => (
          <div key={feat.id}>
